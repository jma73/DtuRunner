...
//        return distanceInMeters;
    ...
    *
    ...
    public static String getAdress(PointInfo pointInfo, Context context)
    {
        if(pointInfo == null)
        {
            return "ingen adresse! ";
        }
        // todo jan 1/2-2016: Dette er under test!!!
        ArrayList<String> adressList = getAdress(pointInfo.getLatitude(), pointInfo.getLongitude(), context);

        // 0=adressen, 1=postnr. og by, 3:? empty!!!
        return adressList.get(0) + ", " + adressList.get(1);// + ", " + adressList.get(2);

        // return "not implemented!";
    }

    private static ArrayList<String> getAdress(double latitude, double longitude  , Context context)
    {
        //  Fra: http://developer.android.com/training/location/display-address.html
...
//        final double longitude = location.getLongitude();
        try {
            ...
            errorMessage = ("R.string.invalid_lat_long_used");
        ...
        if (addresses == null || addresses.size()  == 0) {
            if (errorMessage.isEmpty()) {
                errorMessage = ("R.string.no_address_found");
                Log.e("TAG", errorMessage);
            }
...
//            deliverResultToReceiver(SyncStateContract.Constants.SUCCESS_RESULT, TextUtils.join(System.getProperty("line.separator"), addressFragments));
        }
